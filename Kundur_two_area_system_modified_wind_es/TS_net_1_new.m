...
switch flag
  ...
  %%%%%%%%%%%%%%%%%%
  case 0
    [sys,x0,str,ts,simStateCompliance,YY0,Yff,YGB,YGBd,YGBq]=mdlInitializeSizes(busdata,linedata,VSS0,LINE,nBus,Currentin_idx,fbus,ng,amp);
...
%=============================================================================
%
function [sys,x0,str,ts,simStateCompliance,YY0,Yff,YGB,YGBd,YGBq]=mdlInitializeSizes(busdata,linedata,VSS0,LINE,nBus,Currentin_idx,fbus,ng,amp)
