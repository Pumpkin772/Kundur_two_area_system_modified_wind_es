...
rootdir = 'D:/PycharmProjects/DDID_SAC'
...
def main(args):
    ...
    agent_num = 4
    state_dim = 7 # p, delta f 3, delta f/t 3
    action_dim = 2 # 2 demension
    action_bound = 1 # action (-1,1)
    action_scale = 0.99
    # set the environment
    eng = matlab.engine.start_matlab()
    env_name = 'M4B11_modified'
    ...
    for ep in range(max_episodes):
        ...
        while True:
            ...
            if ModelStatus == 'paused':
                ...
                states, rewards, rewardsF, rewardsH, rewardsD= state_reward_CHD(data, agent_num, counter_step,step_max,args,
